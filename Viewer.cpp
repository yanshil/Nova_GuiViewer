    ...
    : window(NULL), SCR_WIDTH(800), SCR_HEIGHT(600)
{
    ...
    global_camera_pos = glm::vec3(0.0f, -3.0f, -0.3f);
...
void Viewer::Main_Loop()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        local_camera_pos = glm::vec3(0.0f,-2.0f,- t * 0.0001f+0.3f*sin(t_copy/2000.0f));

        glm::vec3 front = glm::vec3(0.0f,2.0f,-0.3f*sin(t_copy/2000.0f));
